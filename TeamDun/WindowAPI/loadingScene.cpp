...
void loadingScene::loadingSound()
{
	...
	_loading->LoadSound("charged ÃæÀüÇü ±â¸ğÀ¸´Â»ç¿îµå", "Sounds/Effect/charged ÃæÀüÇü ±â¸ğÀ¸´Â»ç¿îµå.wav", false, false);
	...
	_loading->LoadSound("°ÔÀÓ_´øÀü_¹®¿­¸²´İÈû", "Sounds/Effect/°ÔÀÓ_´øÀü_¹®¿­¸²´İÈû.wav", false, false);
	...
	_loading->LoadSound("¸Û¸ÛÀÌ ¿Ğ¿Ğ", "Sounds/Effect/¸Û¸ÛÀÌ ¿Ğ¿Ğ.wav", false, false);
	_loading->LoadSound("¸ó½ºÅÍ_±Ã¼ö_¹ß»ç", "Sounds/Effect/¸ó½ºÅÍ_±Ã¼ö_¹ß»ç.wav", false, false);
	_loading->LoadSound("¸ó½ºÅÍ_±Ã¼ö_ÂŞ¿í", "Sounds/Effect/¸ó½ºÅÍ_±Ã¼ö_ÂŞ¿í.wav", false, false);
	...
	_loading->LoadSound("¹«±â_±â°øÅæÆÄ_°ø°İ", "Sounds/Effect/¹«±â_±â°øÅæÆÄ_°ø°İ.wav", false, false);
	...
	_loading->LoadSound("¹«±â_´úµĞÅ¹ÇÑ¹ß»çÀ½", "Sounds/Effect/¹«±â_´úµĞÅ¹ÇÑ¹ß»çÀ½.wav", false, false);
	...
	_loading->LoadSound("¹«±â_µĞÅ¹ÇÑ¹ß»çÀ½", "Sounds/Effect/¹«±â_µĞÅ¹ÇÑ¹ß»çÀ½.wav", false, false);
	...
	_loading->LoadSound("¹«±â_·¯½Ã¾È·ê·¿_½ÇÆĞ", "Sounds/Effect/¹«±â_·¯½Ã¾È·ê·¿_½ÇÆĞ.wav", false, false);
	...
	_loading->LoadSound("¹«±â_¸ğ½º¹ö±×¼¦°Ç", "Sounds/Effect/¹«±â_¸ğ½º¹ö±×¼¦°Ç.wav", false, false);
	...
	_loading->LoadSound("¹«±â_ºÎ¸Ş¶û°è¿­", "Sounds/Effect/¹«±â_ºÎ¸Ş¶û°è¿­.wav", false, false);
	...
	_loading->LoadSound("¹«±â_½½¶óÀÓ¸ŞÀÌÄ¿", "Sounds/Effect/¹«±â_½½¶óÀÓ¸ŞÀÌÄ¿.wav", false, false);
	...
	_loading->LoadSound("¹«±â_¿îµğ³×Ã¢È¿°ú", "Sounds/Effect/¹«±â_¿îµğ³×Ã¢È¿°ú.wav", false, false);
	...
	_loading->LoadSound("¹«±â_È£¶ûÀÌ±Ç¹ı", "Sounds/Effect/¹«±â_È£¶ûÀÌ±Ç¹ı.wav", false, false);
	...
	_loading->LoadSound("¹«¾ğ°¡¿¡Âñ¸²", "Sounds/Effect/¹«¾ğ°¡¿¡Âñ¸².wav", false, false);
	...
	_loading->LoadSound("º¸½º_¾Æ¸£»ş_¹ßÆÇ¼ÒÈ¯", "Sounds/Effect/º¸½º_¾Æ¸£»ş_¹ßÆÇ¼ÒÈ¯.wav", false, false);
	_loading->LoadSound("º¸½º_¾Æ¸£»ş_ºÒ¸´¹ß»ç", "Sounds/Effect/º¸½º_¾Æ¸£»ş_ºÒ¸´¹ß»ç.wav", false, false);
	_loading->LoadSound("º¸½º_¾Æ¸£»ş_Àû¼ÒÈ¯", "Sounds/Effect/º¸½º_¾Æ¸£»ş_Àû¼ÒÈ¯.wav", false, false);
	...
	_loading->LoadSound("º¸½º_¿¡¸®Â÷_½ºÆÄÀÌÅ©°ø°İ", "Sounds/Effect/º¸½º_¿¡¸®Â÷_½ºÆÄÀÌÅ©°ø°İ.wav", false, false);
	_loading->LoadSound("º¸½º_¿¡¸®Â÷_¿ïºÎÂ¢À»¶§µŞ¼Ò¸®", "Sounds/Effect/º¸½º_¿¡¸®Â÷_¿ïºÎÂ¢À»¶§µŞ¼Ò¸®.wav", false, false);
	_loading->LoadSound("º¸½º_¿¡¸®Ä«_´ÙÀ½ÆĞÅÏ", "Sounds/Effect/º¸½º_¿¡¸®Ä«_´ÙÀ½ÆĞÅÏ.wav", false, false);
	...
	_loading->LoadSound("º¸½º_¿¡¸®Ä«_½ºÆÄÀÌÅ©°ø°İ", "Sounds/Effect/º¸½º_¿¡¸®Ä«_½ºÆÄÀÌÅ©°ø°İ.wav", false, false);
	...
	_loading->LoadSound("º¸½º_Ä«¹Ì³Ú¶ó_¹«¾ğ°¡", "Sounds/Effect/º¸½º_Ä«¹Ì³Ú¶ó_¹«¾ğ°¡.wav", false, false);
	...
	_loading->LoadSound("»ş¶ó¶ö¶ó¶ö¶ö¶ó", "Sounds/Effect/»ş¶ó¶ö¶ó¶ö¶ö¶ó.wav", false, false);
	_loading->LoadSound("»ş¹æ»ş¹æ", "Sounds/Effect/»ş¹æ»ş¹æ.wav", false, false);
	...
	_loading->LoadSound("¾ÆÀÌÀÛÄİ¶óº¸ (1)", "Sounds/Effect/¾ÆÀÌÀÛÄİ¶óº¸ (1).wav", false, false);
	_loading->LoadSound("¾ÆÀÌÀÛÄİ¶óº¸ (2)", "Sounds/Effect/¾ÆÀÌÀÛÄİ¶óº¸ (2).wav", false, false);
	_loading->LoadSound("¾ÆÀÌÀÛÄİ¶óº¸ (3)", "Sounds/Effect/¾ÆÀÌÀÛÄİ¶óº¸ (3).wav", false, false);
	_loading->LoadSound("¾ÆÀÌÀÛÄİ¶óº¸ (4)", "Sounds/Effect/¾ÆÀÌÀÛÄİ¶óº¸ (4).wav", false, false);
	...
	_loading->LoadSound("¾ÆÀÌÅÛ_¸ŞÀÌ½º½ºÅÏ", "Sounds/Effect/¾ÆÀÌÅÛ_¸ŞÀÌ½º½ºÅÏ.wav", false, false);
	_loading->LoadSound("¾ÆÀÌÅÛ_¾ÆÀÌÅÛ_¾Ç¸¶ÀÇ¼Õ", "Sounds/Effect/¾ÆÀÌÅÛ_¾ÆÀÌÅÛ_¾Ç¸¶ÀÇ¼Õ.wav", false, false);

	_loading->LoadSound("¾ÆÀÌÅÛ_Àü±âÃæ°İ±â", "Sounds/Effect/¾ÆÀÌÅÛ_Àü±âÃæ°İ±â.wav", false, false);
	...
	_loading->LoadSound("¾ÏÈæ¸¶¹ı°°Àº¹ß»çÀ½", "Sounds/Effect/¾ÏÈæ¸¶¹ı°°Àº¹ß»çÀ½.wav", false, false);
